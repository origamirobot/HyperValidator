	...
	public class CoreAppSettingsReader : AppSettingsReader, IAppSettingsReader
	{
		...
		public Boolean ReadBooleanAppSetting(String key, String configFile)
		{
			...
			if (config != null)
			{
				try
				{
					if (Boolean.TryParse(config.Elements.GetValue(key), out bool val))
						return val;
				}
				catch (Exception ex)
				{
		...
		public Boolean ReadBooleanAppSettingFromDefaultStore(String key)
		{
			try
			{
				if (Boolean.TryParse(GetValue(key, typeof(String)) as String, out bool val))
					return val;
			}
			catch (Exception ex)
			{
		...
		public Boolean ReadOptionalBooleanAppSetting(String key, Boolean defaultValue)
		{
			try
			{
				...
				if (keyValue != null)
				{
					if (Boolean.TryParse(keyValue, out bool val))
						return val;
				}
			}
			catch { }
		...
		public Int32 ReadOptionalIntAppSetting(String key, Int32 defaultValue)
		{
			try
			{
				...
				if (keyValue != null)
				{
					if (Int32.TryParse(keyValue, out int val))
						return val;
				}
			}
			catch { }
		...
		public Int32 ReadIntAppSetting(String key, String configFile)
		{
			...
			if (config != null)
			{
				try
				{
					if (Int32.TryParse(config.Elements.GetValue(key), out int val))
						return val;
				}
				catch (Exception ex)
				{
		...
		public Int32 ReadIntAppSettingFromDefaultStore(String key)
		{
			try
			{
				if (Int32.TryParse(GetValue(key, typeof(String)) as String, out int val))
					return val;
			}
			catch (Exception ex)
			{
		...
		public Single ReadOptionalSingleAppSetting(String key, String configFile, Single defaultValue)
		{
			try
			{
				...
				if (config != null)
				{
					if (Single.TryParse(config.Elements.GetValue(key), out float val))
						return val;
				}
			}
			catch { }
		...
		public Decimal ReadDecimalAppSetting(String key, String configFile)
		{
			...
			if (config != null)
			{
				try
				{
					if (Decimal.TryParse(config.Elements.GetValue(key), out decimal val))
						return val;
				}
				catch (Exception ex)
				{
		...
		public Decimal ReadDecimalAppSettingFromDefaultStore(String key)
		{
			try
			{
				if (Decimal.TryParse(GetValue(key, typeof(String)) as String, out decimal val))
					return val;
			}
			catch (Exception ex)
			{
		...
		public Decimal ReadOptionalDecimalAppSetting(String key, Decimal defaultValue)
		{
			try
			{
				...
				if (keyValue != null)
				{
					if (Decimal.TryParse(keyValue, out decimal val))
						return val;
				}
			}
			catch { }
		...
		public T ReadEnumAppSetting<T>(String key, String configFile) where T : struct, IConvertible
		{
			...
			if (config != null)
			{
				try
				{
					...
					if (Enum.TryParse<T>(keyValue, out T val))
						return val;
				}
				catch (Exception ex)
				{
		...
		public T ReadOptionalEnumAppSetting<T>(String key, String configFile, T defaultValue) where T : struct, IConvertible
		{
			try
			{
				...
				if (config != null)
				{
					if (Enum.TryParse<T>(config.Elements.GetValue(key), out T val))
						return val;
				}
			}
			catch { }
